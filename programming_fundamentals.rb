...
dirtrain111 = trains.last[:direction]

# 2. Save the frequency of train 80B into a variable.

freqtrain80b = trains[5][:frequency_in_minutes]

# 3. Save the direction of train 610 into a variable.

dirtrain610 = trains.last[:direction]
...
direction("north", trains)
direction("east", trains)
